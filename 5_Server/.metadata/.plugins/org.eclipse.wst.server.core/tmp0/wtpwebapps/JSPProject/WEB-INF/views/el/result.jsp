...
<body>
	...
	<br>
	<br> 2) EL(표현언어) : ${ param.inputName } / ${ param.inputAge } / ${ param.inputAddress }
	...
	<pre>
	 	EL에서 null을 출력해야 되는 경우 ""(빈 문자열을 출력한다.)
	 	+ NullPointerException이 발생하는 코드에서도 "" (빈 문자열)을 출력한다. 
	 	+ EL은 null은 경우를 확인할 때 empty를 통해서 확인 할 수 있다. 
	 	EL == NULL ""빈 문자열 /empty "" 빈문자열을 검사하기 위해 사용
	 </pre>
