...
for(let item of area){
    //item == area배열에 담김 요소를 순차적으로 하나씩 꺼내는 저장변수
...
//     area[i].style.flexDirection = "column"; // 메인 축 방향을 열(세로)로 설정
//   }
...
for(let i =0;i<boxColor.length;i++){
    ...
    //change: 포커스를 잃고나서 또는 엔터 입력시 작성된 값이 이전과 다를 경우 
    //blur : 포커스를 잃었을때
