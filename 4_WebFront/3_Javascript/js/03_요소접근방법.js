...
function accessClass(){
    ...
    arr[1].innerHTML = "두번째요소";

    arr[2].style.backgroundColor="skyblue";
    arr[2].innerHTML = "세번째요소";
...
//name으로 접근하기 
 function accessName(){
   ...
   name.innerText=str;
    ...
    document.getElementById("name-div").innerHTML += "<br>선택한 개수" + count;
...
function accessCss(){
    ...
    //각자 다른 색상 지정
    //arr[0].style.backgroundColor="pink";
    //arr[1].style.backgroundColor="gold";
